					...
					<div class="side-app">
						...
						<div class="row">
							<div class="col-sm-12 col-md-12 col-lg-12 col-xl-9">
								<div class="card">
									...
									<div class="card-body pb-0">
										<!-- ดูจากไฟล์ index1.js -->
										<div id="chart_total_order" class="chart-donut"></div>
									</div>
								</div>
							</div><!-- COL END -->
							<!--<div class="col-sm-12 col-md-12 col-lg-12 col-xl-3">
								<div class="card custom-card ">
									<div class="card-header">
										<h3 class="card-title">Recent Orders (Demo)</h3>
									</div>
						...
						<div class="row">
							<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
								<div class="card">
									...
									<div class="card-body pb-0">
										<!-- ดูจากไฟล์ index1.js -->
										<div id="chart_total_sale" class="chart-donut"></div>
										<script>
											page_loading("show");
											$.ajax({  
												type: "POST", 
												url: "<?=$_dr_api?>/manage_dashboard.php", 
												data: { "action":"query_for_chart_area_order"},
												success:function(respon){
													...
													if(json["status"] == 1){
														...
														let chart = new ApexCharts(document.querySelector("#chart_total_order"), options);
														chart.render();
														...
														let chart2 = new ApexCharts(document.querySelector("#chart_total_sale"), options2);
														chart2.render();
													}else{
						...
						<div class="row">
							<!-- <div class="col-xl-4 col-md-12">
								<div class="card overflow-hidden">
									<div class="card-header">
										<div>
											<h3 class="card-title">Timeline (Demo)</h3>
										</div>
									</div>
							...
							<div class="col-xl-4 col-md-12">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title fw-semibold ">Browser Usage (Demo)</h4>
									</div>
							...
							<div class="col-xl-4 col-md-12">
								<div class="card">
									<div class="card-header">
										<h4 class="card-title fw-semibold ">Daily Activity (Demo)</h4>
									</div>
									<div class="card-body pb-0">
										<ul class="task-list">
											<li>
						...
						<div class="row">
							<!--<div class="col-12 col-sm-12">
								<div class="card ">
									<div class="card-header">
										<h3 class="card-title mb-0">Product Sales (Demo)</h3>
									</div>
									<div class="card-body">
