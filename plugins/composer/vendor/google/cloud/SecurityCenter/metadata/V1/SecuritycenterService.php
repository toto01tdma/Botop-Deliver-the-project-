...
name (	B4‡A˙A.
,securitycenter.googleapis.com/BigQueryExport2Çt
SecurityCenter‚
...
&GetSecurityHealthAnalyticsCustomModuleM.google.cloud.securitycenter.v1.GetSecurityHealthAnalyticsCustomModuleRequestC.google.cloud.securitycenter.v1.SecurityHealthAnalyticsCustomModule"ÎÇ”‰ì›J/v1/{name=organizations/*/securityHealthAnalyticsSettings/customModules/*}ZFD/v1/{name=folders/*/securityHealthAnalyticsSettings/customModules/*}ZGE/v1/{name=projects/*/securityHealthAnalyticsSettings/customModules/*}⁄Anameö
	GetSource0.google.cloud.securitycenter.v1.GetSourceRequest&.google.cloud.securitycenter.v1.Source"3Ç”‰ì&$/v1/{name=organizations/*/sources/*}⁄AnameÉ
GroupAssets2.google.cloud.securitycenter.v1.GroupAssetsRequest3.google.cloud.securitycenter.v1.GroupAssetsResponse"äÇ”‰ìÉ")/v1/{parent=organizations/*}/assets:group:*Z("#/v1/{parent=folders/*}/assets:group:*Z)"$/v1/{parent=projects/*}/assets:group:*ø
GroupFindings4.google.cloud.securitycenter.v1.GroupFindingsRequest5.google.cloud.securitycenter.v1.GroupFindingsResponse"¿Ç”‰ìß"5/v1/{parent=organizations/*/sources/*}/findings:group:*Z4"//v1/{parent=folders/*/sources/*}/findings:group:*Z5"0/v1/{parent=projects/*/sources/*}/findings:group:*⁄Aparent,group_by„

ListAssets1.google.cloud.securitycenter.v1.ListAssetsRequest2.google.cloud.securitycenter.v1.ListAssetsResponse"nÇ”‰ìh#/v1/{parent=organizations/*}/assetsZ/v1/{parent=folders/*}/assetsZ /v1/{parent=projects/*}/assetsà
...
ListSources2.google.cloud.securitycenter.v1.ListSourcesRequest3.google.cloud.securitycenter.v1.ListSourcesResponse"zÇ”‰ìk$/v1/{parent=organizations/*}/sourcesZ /v1/{parent=folders/*}/sourcesZ!/v1/{parent=projects/*}/sources⁄Aparentá
RunAssetDiscovery8.google.cloud.securitycenter.v1.RunAssetDiscoveryRequest.google.longrunning.Operation"òÇ”‰ì5"0/v1/{parent=organizations/*}/assets:runDiscovery:*⁄Aparent AQ
