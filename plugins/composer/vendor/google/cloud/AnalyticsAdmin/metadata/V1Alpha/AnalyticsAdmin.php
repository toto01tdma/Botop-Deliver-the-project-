...
parent (	B3àAúA-+analyticsadmin.googleapis.com/AccessBindingB
names (	B3àAúA-
...
parent (	B3àAúA-+analyticsadmin.googleapis.com/AccessBinding
	page_size (
...
parent (	B3àAúA-+analyticsadmin.googleapis.com/AccessBindingJ
access_binding (2-.google.analytics.admin.v1alpha.AccessBindingBàA"º
 BatchCreateAccessBindingsRequestC
parent (	B3àAúA-+analyticsadmin.googleapis.com/AccessBindingQ
requests (2:.google.analytics.admin.v1alpha.CreateAccessBindingRequestBàA"k
...
parent (	B3àAúA-+analyticsadmin.googleapis.com/AccessBindingQ
requests (2:.google.analytics.admin.v1alpha.UpdateAccessBindingRequestBàA"k
...
parent (	B3àAúA-+analyticsadmin.googleapis.com/AccessBindingQ
requests (2:.google.analytics.admin.v1alpha.DeleteAccessBindingRequestBàA"¶
CreateExpandedDataSetRequestE
parent (	B5àAúA/-analyticsadmin.googleapis.com/ExpandedDataSetO
expanded_data_set (2/.google.analytics.admin.v1alpha.ExpandedDataSetBàA"¥
UpdateExpandedDataSetRequestO
expanded_data_set (2/.google.analytics.admin.v1alpha.ExpandedDataSetBàA4
...
parent (	B5àAúA/-analyticsadmin.googleapis.com/ExpandedDataSet
	page_size (
...
parent (	B2àAúA,*analyticsadmin.googleapis.com/ChannelGroupH
channel_group (2,.google.analytics.admin.v1alpha.ChannelGroupBàA"›
UpdateChannelGroupRequestH
channel_group (2,.google.analytics.admin.v1alpha.ChannelGroupBàA4
update_mask (2.google.protobuf.FieldMaskBàA"]
...
parent (	B2àAúA,*analyticsadmin.googleapis.com/ChannelGroup
	page_size (
...
enhanced_measurement_settings (2;.google.analytics.admin.v1alpha.EnhancedMeasurementSettingsBàA4
update_mask (2.google.protobuf.FieldMaskBàA"„
CreateConnectedSiteTagRequest
property (	Q
connected_site_tag (20.google.analytics.admin.v1alpha.ConnectedSiteTagBàA" 
...
parent (	B1àAúA+)analyticsadmin.googleapis.com/AdSenseLinkF
adsense_link (2+.google.analytics.admin.v1alpha.AdSenseLinkBàA"X
GetAdSenseLinkRequest?
name (	B1àAúA+
)analyticsadmin.googleapis.com/AdSenseLink"[
DeleteAdSenseLinkRequest?
name (	B1àAúA+
)analyticsadmin.googleapis.com/AdSenseLink"ƒ
ListAdSenseLinksRequestA
parent (	B1àAúA+)analyticsadmin.googleapis.com/AdSenseLink
	page_size (
...
parent (	B5àAúA/-analyticsadmin.googleapis.com/EventCreateRuleO
event_create_rule (2/.google.analytics.admin.v1alpha.EventCreateRuleBàA"¥
UpdateEventCreateRuleRequestO
event_create_rule (2/.google.analytics.admin.v1alpha.EventCreateRuleBàA4
update_mask (2.google.protobuf.FieldMaskBàA"c
...
parent (	B5àAúA/-analyticsadmin.googleapis.com/EventCreateRule
	page_size (
...
UpdateSearchAds360Link=.google.analytics.admin.v1alpha.UpdateSearchAds360LinkRequest0.google.analytics.admin.v1alpha.SearchAds360Link"ƒ‚Óä“[2D/v1alpha/{search_ads_360_link.name=properties/*/searchAds360Links/*}:search_ads_360_linkÚAsearch_ads_360_link,update_maskÍ
...
UpdateAttributionSettings@.google.analytics.admin.v1alpha.UpdateAttributionSettingsRequest3.google.analytics.admin.v1alpha.AttributionSettings"†‚Óä“]2E/v1alpha/{attribution_settings.name=properties/*/attributionSettings}:attribution_settingsÚA attribution_settings,update_maskð
RunAccessReport6.google.analytics.admin.v1alpha.RunAccessReportRequest7.google.analytics.admin.v1alpha.RunAccessReportResponse"l‚Óä“f"./v1alpha/{entity=properties/*}:runAccessReport:*Z1",/v1alpha/{entity=accounts/*}:runAccessReport:*Ÿ
CreateAccessBinding:.google.analytics.admin.v1alpha.CreateAccessBindingRequest-.google.analytics.admin.v1alpha.AccessBinding"œ‚Óä“~"+/v1alpha/{parent=accounts/*}/accessBindings:access_bindingZ?"-/v1alpha/{parent=properties/*}/accessBindings:access_bindingÚAparent,access_bindingç
GetAccessBinding7.google.analytics.admin.v1alpha.GetAccessBindingRequest-.google.analytics.admin.v1alpha.AccessBinding"k‚Óä“^+/v1alpha/{name=accounts/*/accessBindings/*}Z/-/v1alpha/{name=properties/*/accessBindings/*}ÚAname·
UpdateAccessBinding:.google.analytics.admin.v1alpha.UpdateAccessBindingRequest-.google.analytics.admin.v1alpha.AccessBinding"´‚Óä“œ2:/v1alpha/{access_binding.name=accounts/*/accessBindings/*}:access_bindingZN2</v1alpha/{access_binding.name=properties/*/accessBindings/*}:access_bindingÚAaccess_bindingÖ
DeleteAccessBinding:.google.analytics.admin.v1alpha.DeleteAccessBindingRequest.google.protobuf.Empty"k‚Óä“^*+/v1alpha/{name=accounts/*/accessBindings/*}Z/*-/v1alpha/{name=properties/*/accessBindings/*}ÚAnameú
ListAccessBindings9.google.analytics.admin.v1alpha.ListAccessBindingsRequest:.google.analytics.admin.v1alpha.ListAccessBindingsResponse"m‚Óä“^+/v1alpha/{parent=accounts/*}/accessBindingsZ/-/v1alpha/{parent=properties/*}/accessBindingsÚAparent¥
BatchCreateAccessBindings@.google.analytics.admin.v1alpha.BatchCreateAccessBindingsRequestA.google.analytics.admin.v1alpha.BatchCreateAccessBindingsResponse"‚‚Óä“|"7/v1alpha/{parent=accounts/*}/accessBindings:batchCreate:*Z>"9/v1alpha/{parent=properties/*}/accessBindings:batchCreate:*
BatchGetAccessBindings=.google.analytics.admin.v1alpha.BatchGetAccessBindingsRequest>.google.analytics.admin.v1alpha.BatchGetAccessBindingsResponse"v‚Óä“p4/v1alpha/{parent=accounts/*}/accessBindings:batchGetZ86/v1alpha/{parent=properties/*}/accessBindings:batchGet¥
BatchUpdateAccessBindings@.google.analytics.admin.v1alpha.BatchUpdateAccessBindingsRequestA.google.analytics.admin.v1alpha.BatchUpdateAccessBindingsResponse"‚‚Óä“|"7/v1alpha/{parent=accounts/*}/accessBindings:batchUpdate:*Z>"9/v1alpha/{parent=properties/*}/accessBindings:batchUpdate:*ú
BatchDeleteAccessBindings@.google.analytics.admin.v1alpha.BatchDeleteAccessBindingsRequest.google.protobuf.Empty"‚‚Óä“|"7/v1alpha/{parent=accounts/*}/accessBindings:batchDelete:*Z>"9/v1alpha/{parent=properties/*}/accessBindings:batchDelete:*À
GetExpandedDataSet9.google.analytics.admin.v1alpha.GetExpandedDataSetRequest/.google.analytics.admin.v1alpha.ExpandedDataSet">‚Óä“1//v1alpha/{name=properties/*/expandedDataSets/*}ÚAnameÓ
ListExpandedDataSets;.google.analytics.admin.v1alpha.ListExpandedDataSetsRequest<.google.analytics.admin.v1alpha.ListExpandedDataSetsResponse"@‚Óä“1//v1alpha/{parent=properties/*}/expandedDataSetsÚAparentí
CreateExpandedDataSet<.google.analytics.admin.v1alpha.CreateExpandedDataSetRequest/.google.analytics.admin.v1alpha.ExpandedDataSet"e‚Óä“D"//v1alpha/{parent=properties/*}/expandedDataSets:expanded_data_setÚAparent,expanded_data_set„
UpdateExpandedDataSet<.google.analytics.admin.v1alpha.UpdateExpandedDataSetRequest/.google.analytics.admin.v1alpha.ExpandedDataSet"|‚Óä“V2A/v1alpha/{expanded_data_set.name=properties/*/expandedDataSets/*}:expanded_data_setÚAexpanded_data_set,update_mask­
DeleteExpandedDataSet<.google.analytics.admin.v1alpha.DeleteExpandedDataSetRequest.google.protobuf.Empty">‚Óä“1*//v1alpha/{name=properties/*/expandedDataSets/*}ÚAname´
GetChannelGroup6.google.analytics.admin.v1alpha.GetChannelGroupRequest,.google.analytics.admin.v1alpha.ChannelGroup";‚Óä“.,/v1alpha/{name=properties/*/channelGroups/*}ÚAnameÇ
ListChannelGroups8.google.analytics.admin.v1alpha.ListChannelGroupsRequest9.google.analytics.admin.v1alpha.ListChannelGroupsResponse"=‚Óä“.,/v1alpha/{parent=properties/*}/channelGroupsÚAparentÙ
CreateChannelGroup9.google.analytics.admin.v1alpha.CreateChannelGroupRequest,.google.analytics.admin.v1alpha.ChannelGroup"Z‚Óä“=",/v1alpha/{parent=properties/*}/channelGroups:channel_groupÚAparent,channel_groupì
UpdateChannelGroup9.google.analytics.admin.v1alpha.UpdateChannelGroupRequest,.google.analytics.admin.v1alpha.ChannelGroup"m‚Óä“K2:/v1alpha/{channel_group.name=properties/*/channelGroups/*}:channel_groupÚAchannel_group,update_mask¤
DeleteChannelGroup9.google.analytics.admin.v1alpha.DeleteChannelGroupRequest.google.protobuf.Empty";‚Óä“.*,/v1alpha/{name=properties/*/channelGroups/*}ÚAnameþ
...
ListBigQueryLinks8.google.analytics.admin.v1alpha.ListBigQueryLinksRequest9.google.analytics.admin.v1alpha.ListBigQueryLinksResponse"=‚Óä“.,/v1alpha/{parent=properties/*}/bigQueryLinksÚAparentû
GetEnhancedMeasurementSettingsE.google.analytics.admin.v1alpha.GetEnhancedMeasurementSettingsRequest;.google.analytics.admin.v1alpha.EnhancedMeasurementSettings"U‚Óä“HF/v1alpha/{name=properties/*/dataStreams/*/enhancedMeasurementSettings}ÚAnameå
...
CreateConnectedSiteTag=.google.analytics.admin.v1alpha.CreateConnectedSiteTagRequest>.google.analytics.admin.v1alpha.CreateConnectedSiteTagResponse"5‚Óä“/"*/v1alpha/properties:createConnectedSiteTag:*¦
DeleteConnectedSiteTag=.google.analytics.admin.v1alpha.DeleteConnectedSiteTagRequest.google.protobuf.Empty"5‚Óä“/"*/v1alpha/properties:deleteConnectedSiteTag:*Ê
ListConnectedSiteTags<.google.analytics.admin.v1alpha.ListConnectedSiteTagsRequest=.google.analytics.admin.v1alpha.ListConnectedSiteTagsResponse"4‚Óä“.")/v1alpha/properties:listConnectedSiteTags:*×
FetchConnectedGa4Property@.google.analytics.admin.v1alpha.FetchConnectedGa4PropertyRequestA.google.analytics.admin.v1alpha.FetchConnectedGa4PropertyResponse"5‚Óä“/-/v1alpha/properties:fetchConnectedGa4Property°
GetAdSenseLink5.google.analytics.admin.v1alpha.GetAdSenseLinkRequest+.google.analytics.admin.v1alpha.AdSenseLink":‚Óä“-+/v1alpha/{name=properties/*/adSenseLinks/*}ÚAnameÓ
CreateAdSenseLink8.google.analytics.admin.v1alpha.CreateAdSenseLinkRequest+.google.analytics.admin.v1alpha.AdSenseLink"W‚Óä“;"+/v1alpha/{parent=properties/*}/adSenseLinks:adsense_linkÚAparent,adsense_link¡
DeleteAdSenseLink8.google.analytics.admin.v1alpha.DeleteAdSenseLinkRequest.google.protobuf.Empty":‚Óä“-*+/v1alpha/{name=properties/*/adSenseLinks/*}ÚAnameÃ
ListAdSenseLinks7.google.analytics.admin.v1alpha.ListAdSenseLinksRequest8.google.analytics.admin.v1alpha.ListAdSenseLinksResponse"<‚Óä“-+/v1alpha/{parent=properties/*}/adSenseLinksÚAparentÎ
GetEventCreateRule9.google.analytics.admin.v1alpha.GetEventCreateRuleRequest/.google.analytics.admin.v1alpha.EventCreateRule"L‚Óä“?=/v1alpha/{name=properties/*/dataStreams/*/eventCreateRules/*}ÚAnameá
ListEventCreateRules;.google.analytics.admin.v1alpha.ListEventCreateRulesRequest<.google.analytics.admin.v1alpha.ListEventCreateRulesResponse"N‚Óä“?=/v1alpha/{parent=properties/*/dataStreams/*}/eventCreateRulesÚAparentû
CreateEventCreateRule<.google.analytics.admin.v1alpha.CreateEventCreateRuleRequest/.google.analytics.admin.v1alpha.EventCreateRule"s‚Óä“R"=/v1alpha/{parent=properties/*/dataStreams/*}/eventCreateRules:event_create_ruleÚAparent,event_create_rule“
UpdateEventCreateRule<.google.analytics.admin.v1alpha.UpdateEventCreateRuleRequest/.google.analytics.admin.v1alpha.EventCreateRule"Š‚Óä“d2O/v1alpha/{event_create_rule.name=properties/*/dataStreams/*/eventCreateRules/*}:event_create_ruleÚAevent_create_rule,update_mask»
DeleteEventCreateRule<.google.analytics.admin.v1alpha.DeleteEventCreateRuleRequest.google.protobuf.Empty"L‚Óä“?*=/v1alpha/{name=properties/*/dataStreams/*/eventCreateRules/*}ÚAnameüÊAanalyticsadmin.googleapis.comÒAØhttps://www.googleapis.com/auth/analytics.edit,https://www.googleapis.com/auth/analytics.manage.users,https://www.googleapis.com/auth/analytics.manage.users.readonly,https://www.googleapis.com/auth/analytics.readonlyB{
